#!/usr/bin/env bash
# Run Alembic migrations only for the schemas required by the member portal:
#   auth_svc, member_svc, appointment_svc, visit_management_svc
set -euo pipefail
...
SERVICES="auth_svc member_svc appointment_svc visit_management_svc"
...
echo ""
echo "=== Running member-stack migrations ==="
...
echo ""
echo "=== Member-stack migrations complete ==="
