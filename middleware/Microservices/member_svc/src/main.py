"""member_svc entrypoint — auto-migrates on startup."""
...
def create_app() -> FastAPI:
    ...
    try:
        ...
        print(f"[member_svc] auto-migrate warning: {e}")

    application = FastAPI(title="member_svc", version="0.1.0")
    ...
    def version():
        return {"service": "member_svc", "version": "0.1.0"}
