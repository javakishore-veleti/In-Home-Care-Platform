"""document_intelligence_svc entrypoint — auto-migrates on startup."""
...
def create_app() -> FastAPI:
    ...
    try:
        ...
        print(f"[document_intelligence_svc] auto-migrate warning: {e}")

    application = FastAPI(title="document_intelligence_svc", version="0.1.0")
    ...
    def version():
        return {"service": "document_intelligence_svc", "version": "0.1.0"}
