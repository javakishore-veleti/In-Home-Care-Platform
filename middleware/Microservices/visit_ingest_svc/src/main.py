"""visit_ingest_svc entrypoint — auto-migrates on startup."""
...
def create_app() -> FastAPI:
    ...
    try:
        ...
        print(f"[visit_ingest_svc] auto-migrate warning: {e}")

    application = FastAPI(title="visit_ingest_svc", version="0.1.0")
    ...
    def version():
        return {"service": "visit_ingest_svc", "version": "0.1.0"}
