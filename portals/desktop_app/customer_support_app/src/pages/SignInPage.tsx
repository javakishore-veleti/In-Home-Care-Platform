...
export function SignInPage() {
  ...
  const [email, setEmail] = useState('supportuser01@inhomecare.local')
  const [password, setPassword] = useState('Support@123')
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F4F7FA] px-4">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-lg font-bold text-[#1A2B3C]">Customer Support</h1>
        ...
        <p className="mt-4 text-[10px] text-[#3D5A73] leading-snug">
          Default support credential for local dev: <code>supportuser01@inhomecare.local</code> / <code>Support@123</code>.
          Admins can also sign in here.
        </p>
      </form>
    </div>
  )
